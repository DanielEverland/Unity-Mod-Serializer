...
namespace UMS.Reflection
{
    ...
    {
        internal MetaProperty(Config config, FieldInfo field)
        {
            _memberInfo = field;
        ...
        internal MetaProperty(Config config, PropertyInfo property)
        {
        ...
        private void CommonInitialize(Config config)
        {
            var attr = PortableReflection.GetAttribute<PropertyAttribute>(_memberInfo);
            if (attr != null)
            {
                JsonName = attr.Name;
        ...
        /// <summary>
        /// A custom BaseConverter instance to use for this field/property, if
        /// requested. This will be null if the default converter selection
        /// algorithm should be used. This is specified using the [Object]
