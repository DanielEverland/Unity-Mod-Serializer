...
namespace UMS
{
    ...
    public class Config
    {
        ...
        /// serialized.
        /// </summary>
        public Type[] IgnoreSerializeAttributes = { typeof(NonSerializedAttribute), typeof(IgnoreAttribute) };

        /// <summary>
        /// The attributes on a type that will force any fields or properties
		/// of that type to *not* be serialized.
        /// </summary>
        public Type[] IgnoreSerializeTypeAttributes = { typeof(IgnoreAttribute) };

        /// <summary>
        /// The default member serialization.
        /// </summary>
        public MemberSerialization DefaultMemberSerialization = MemberSerialization.Default;
        ...
        /// with:
        ///
        /// Config.GetJsonNameFromMemberName = (name, info) =&gt;
        /// name.ToLower();
        ///
        ...
        /// - even properties explicitly annotated with Property or any other
        /// opt-in annotation.
        ///
