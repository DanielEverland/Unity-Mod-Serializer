...
{
    public class BaseObjectWriter : UnityEngineObjectEntryWriter<UnityEngine.Object>
    {

    }
    public abstract class UnityEngineObjectEntryWriter<T> : DefaultEntryWriter<T> where T : UnityEngine.Object
    {
