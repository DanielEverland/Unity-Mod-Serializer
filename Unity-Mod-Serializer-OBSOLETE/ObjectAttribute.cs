...
namespace UMS
{
    ...
    public sealed class ObjectAttribute : Attribute
    {
        ...
        /// behavior is MemberSerialization.Default.
        /// </summary>
        ...
        /// type needs to derive from BaseConverter. This defaults to null.
        /// </summary>
        public Type Converter;

        /// <summary>
        /// Specify a custom processor to use during serialization. The processor
        /// type needs to derive from ObjectProcessor and the call to
